      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-xl">
          ...
          <div className="flex flex-col items-center text-center space-y-md">
            <div className="w-24 h-24 bg-primary-container border-4 border-black rounded-none flex items-center justify-center font-headline-md text-headline-md text-black neobrutal-shadow">
              1
            </div>
          ...
          {/* Step 2: Analyze */}
          <div className="flex flex-col items-center text-center space-y-md">
            <div className="w-24 h-24 bg-tertiary-container border-4 border-black rounded-none flex items-center justify-center font-headline-md text-headline-md text-black neobrutal-shadow">
              2
            </div>
          ...
          {/* Step 3: Conquer */}
          <div className="flex flex-col items-center text-center space-y-md">
            <div className="w-24 h-24 bg-secondary-fixed border-4 border-black rounded-none flex items-center justify-center font-headline-md text-headline-md text-black neobrutal-shadow">
              3
            </div>
